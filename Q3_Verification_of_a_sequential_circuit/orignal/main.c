...
int main (int argc, char* argv[])
{
    ...
    bdd s33 = bdd_and(bddm, r2_not, bdd_or(bddm, bdd_and(bddm, x2, s22), bdd_and(bddm, x2_not, s02)));
    // output at K=2
    ...
    bdd s34 = bdd_and(bddm, r3_not, bdd_or(bddm, bdd_and(bddm, x3, s23), bdd_and(bddm, x3_not, s03)));
    // output at K=3
